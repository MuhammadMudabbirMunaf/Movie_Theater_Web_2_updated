...
function signupRemoval() {
  ...
  if (confirmPassword === "" || confirmPassword === " ") {
    var confirmPassword = document.getElementById("confirmPassword").style.border = "2px solid red";
  }
  if (address === "" || address === " ") {
    var address = document.getElementById("address").style.border = "2px solid red";
  }
  if (dob === "" || dob === " ") {
    var dob = document.getElementById("dob").style.border = "2px solid red";
  }
  if (profilePic === "" || profilePic === " ") {
    var profilePic = document.getElementById("picChoose").style.border = "px solid red";
  }
  if (number === "" || num === " ") {
